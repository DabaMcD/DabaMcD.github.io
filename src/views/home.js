    ...
    <div className="home-container1">
        ...
        <header data-thq="thq-navbar" className="home-navbar-interactive">
          ...
          >
            <nav className="home-links1">
              ...
              <button className="home-button11 button">Menu</button>
            </nav>
          </div>
          ...
          <div data-thq="thq-mobile-menu" className="home-mobile-menu">
            <div className="home-top">
              <div className="home-branding2">
                ...
                <span className="home-text15">Remarkable</span>
              </div>
            ...
            <nav className="home-links2">
              ...
              <button className="home-button14 button">Menu</button>
            </nav>
      ...
      <header className="home-hero">
        <div className="home-content1">
          <h1 className="home-title1">
            <span className="home-text18">I&apos;m an idiot.</span>
            <br></br>
      ...
      <section className="home-mission1">
        <h2 className="home-text24">
          <span className="home-text25">The world was made for my sake.</span>
          <br></br>
        ...
        <button className="button home-button15">
          <span className="home-text31">Learn about our mission</span>
        </button>
      </section>
          ...
          <div className="home-content2">
            <div className="home-details1">
              <div className="home-header2">
                <h2 className="home-text34">Website Engagement Design</h2>
      ...
      <section className="home-services1">
        <h2 className="home-text40">High-impact business services</h2>
...
`}
      ...
      <section className="home-partners">
        <div className="home-content4">
          <h2 className="home-text55">Our partners</h2>
      ...
      <section className="home-services2">
        <div className="home-heading2">
          <h2 className="home-text57">Take a look at the latest articles</h2>
          ...
          <div className="home-row4">
            <div className="home-section1">
              <div className="home-header3">
                <h3 className="home-text59">Understand your customers</h3>
            ...
            <div className="home-section2">
              <div className="home-header4">
                <h3 className="home-text65">Own your business</h3>
          ...
          <div className="home-row5">
            <div className="home-section3">
              <div className="home-header5">
                <h3 className="home-text71">How to build your team</h3>
            ...
            <div className="home-section4">
              <div className="home-header6">
                <h3 className="home-text77">We can help your business</h3>
      ...
      <section className="home-newsletter">
        <div className="home-header8">
          <h2 className="home-text89">Subscribe to our newsletter</h2>
